...
4. Walk down each branch of the decision tree — for each unresolved branch, explore the codebase if answerable there, otherwise ask one focused question and include your recommended answer.
